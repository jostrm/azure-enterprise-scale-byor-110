...
repo_level_vars=(
  ...
  "ADMIN_AISEARCH_TIER"
  "AIFACTORY_PREFIX_RG"
  "ADMIN_AIFACTORY_PREFIX_RG"
  "ADMIN_AIFACTORY_SUFFIX_RG"
  "PROJECT_PREFIX"
  "PROJECT_SUFFIX"
  ...
  "INPUT_COMMON_SPIDKEY"
  "INPUT_COMMON_SPSECRETKEY"
...
for env in "${selected_environments[@]}"; do
    ...
    create_or_update_variable $env "INPUT_COMMON_SPIDKEY" "$INPUT_COMMON_SPIDKEY"
    create_or_update_variable $env "INPUT_COMMON_SPSECRETKEY" "$INPUT_COMMON_SPSECRETKEY"
